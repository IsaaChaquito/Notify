...
const NotifyContainer = React.memo(() => {
  ...
  return (
    <Flipper flipKey={flipKey} spring={{ stiffness: 600, damping: 60 }} >
      <div
        className={`TOAST-CONTAINER fixed z-40 top-2 right-2 bottom-2 left-2 pointer-events-none flex ${notifyState?.screenPositionStyle}  will-change-transform *:mb-2`}
      >
