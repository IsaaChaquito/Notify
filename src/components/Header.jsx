  ...
  return (
    <div className="relative h-56 w-full">
      ...
      <div className='flex flex-col justify-center items-center duration-300 z-50 p-2'>
        ...
        <a href="https://github.com/IsaaChaquito/Notify" target='_blank' title='Github documentation' className='github-link cursor-pointer w-20 h-20 z-10 absolute flex items-start justify-end top-0 right-0 p-3 hover:scale-125 duration-300 bg-[#1a1a1a]'>
          <GithubIcon className="w-[50%] h-[50%] rotate-45 " />
        </a>
