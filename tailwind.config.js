  ...
  theme: {
    extend: {
      animation: {
        ...
        fadeInDownBig: 'fadeInDownBig 0.6s ease-out',
        fadeOutDown: 'fadeOutDown 0.6s ease-out',
        fadeOutDownBig: 'fadeOutDownBig 0.6s ease-out',
        fadeInTopRight: 'fadeInTopRight 0.6s ease-out',
